...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Organization.user_id":
		if e.complexity.Organization.UserID == nil {
			break
		}

		return e.complexity.Organization.UserID(childComplexity), true
...
func (ec *executionContext) _Organization_user_id(ctx context.Context, field graphql.CollectedField, obj *model.Organization) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Organization(ctx context.Context, sel ast.SelectionSet, obj *model.Organization) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "user_id":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Organization_user_id(ctx, field, obj)
			}
